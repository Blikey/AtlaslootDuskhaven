...
local BabbleZone = AtlasLoot_GetLocaleLibBabble("LibBabble-Zone-3.0")
	...
	AtlasLoot_Data["SETMENU"] = {
		...
		{ 16, "SETSMISCMENU", "INV_Sword_43", "=ds="..AL["Misc Sets"], ""};
		{ 17, "ZGSets1", "INV_Jewelry_Necklace_19", "=ds="..AL["Zul'Gurub Sets"], ""};
	...
	AtlasLoot_Data["MYTHICMENU"] ={
		{ 1, "SEASON1", "inv_misc_gem_variety_01", "Season 1 Rewards", ""};
		{ 2, "SEASON2", "spell_holy_summonchampion", "Season 2 Rewards", ""};
		{ 3, "SEASON3", "inv_misc_questionmark", "Season 3 Rewards", ""};
