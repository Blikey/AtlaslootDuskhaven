...
if AL then
	...
	AL["Mythic Dungeon Set"] = true;
	AL["Mythic Rewards"] = true;
	...
	AL["Mythic Dungeon Sets"] = true;
	AL["Mythic Season 1"] = true;
	AL["Mythic Season 2"] = true;
	AL["Mythic Season 3"] = true;
	AL["Tier 1"] = true;
	AL["Tier 2"] = true;
	AL["Tier 3"] = true;
	AL["Tier 4"] = true;
	...
	-- Mythic Sets
	AL["Bluefang Armor"] = true;
	AL["Dragonsteel Plate"] = true;
	AL["Penance Battlegear"] = true;
	AL["Ruby Plate"] = true;
	AL["Demonfang Regalia"] = true;
	AL["Dreamwing Armor"] = true;
	AL["Vestments of Inner Grace"] = true;
