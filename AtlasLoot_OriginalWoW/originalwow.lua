...
--[[	AtlasLoot_Data["BlackfathomDeeps1MYTHIC"] = {
	...
	AtlasLoot_Data["MCRhannoxHEROIC"] = {
		...
		{ 7, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "1.48%"};
		{ 8, 17110, "", "=q4=Seal of the Archmagus", "=ds=#s13#", "", "21.93%"};
		{ 9, 57057, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "2.61%"};
		{ 10, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "2.68%"};
		{ 11, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "2.59%"};
		{ 12, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "2.70%"};
	...
	AtlasLoot_Data["MCLucifronHEROIC"] = {
		...
		{ 5, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "1.09%"};
		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.15%"};
		{ 7, 57055, "", "=q4=Choker of Enlightenment", "=ds=#s2#", "", "12.61%"};
		{ 8, 57054, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "2.04%"};
		{ 9, 57053, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "2.23%"};
		{ 10, 57052, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "2.23%"};
		{ 11, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "1.60%"};
	...
	AtlasLoot_Data["MCMagmadarHEROIC"] = {
		...
		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "3.98%"};
		{ 7, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "3.22%"};
		{ 8, 57056, "", "=q4=Medallion of Steadfast Might", "=ds=#s2#", "", "14.05%"};
		{ 9, 57057, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "5.79%"};
		{ 10, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "5.55%"};
		{ 11, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "5.42%"};
		{ 12, 18203, "", "=q4=Eskhandar's Right Claw", "=ds=#h3#, #w13#", "", "17.82%"};
		{ 13, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "5.68%"};
		{ 14, 57059, "", "=q4=Earthshaker", "=ds=#h2#, #w6#", "", "16.75%"};
		{ 15, 57060, "", "=q4=Striker's Mark", "=ds=#w2#", "", "16.37%"};
	...
	AtlasLoot_Data["MCGehennasHEROIC"] = {
		...
		{ 5, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "1.77%"};
		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "3.48%"};
		{ 7, 57054, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "3.78%"};
		{ 8, 57053, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "3.78%"};
	...
	AtlasLoot_Data["MCGarrHEROIC"] = {
		...
		{ 9, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "4.13%"};
		{ 10, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "3.69%"};
		{ 11, 57061, "", "=q4=Gutgore Ripper", "=ds=#h1#, #w4#", "", "11.21%"};
		{ 12, 57062, "", "=q4=Brutality Blade", "=ds=#h1#, #w10#", "", "13.27%"};
		{ 13, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "4.09%"};
		{ 14, 57063, "", "=q4=Aurastone Hammer", "=ds=#h3#, #w6#", "", "12.67%"};
		{ 15, 57064, "", "=q4=Drillborer Disk", "=ds=#w8#", "", "11.85%"};
	...
	AtlasLoot_Data["MCShazzrahHEROIC"] = {
		...
		{ 5, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "0.78%"};
		{ 6, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.22%"};
		{ 7, 57054, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "1.72%"};
		{ 8, 57053, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "1.99%"};
		{ 9, 57052, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "2.27%"};
		{ 10, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "3.32%"};
	...
	AtlasLoot_Data["MCGolemaggHEROIC"] = {
		...
		{ 9, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "2.91%"};
		{ 10, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "2.46%"};
		{ 11, 57065, "", "=q4=Azuresong Mageblade", "=ds=#h3#, #w10#", "", "17.59%"};
		{ 12, 57058, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "2.89%"};
		{ 13, 57066, "", "=q4=Staff of Dominance", "=ds=#w9#", "", "18.95%"};
		{ 14, 57067, "", "=q4=Blastershot Launcher", "=ds=#w5#", "", "17.83%"};
	...
	AtlasLoot_Data["MCSulfuronHEROIC"] = {
		...
		{ 8, 57053, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "2.39%"};
		{ 9, 57052, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "2.53%"};
		{ 10, 57068, "", "=q4=Shadowstrike", "=ds=#w7#", "", "23.50%"};
		{ 11, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "2.26%"};
	...
	AtlasLoot_Data["MCMajordomoHEROIC"] = {
		...
		{ 6, 18812, "", "=q4=Wristguards of True Flight", "=ds=#s8#, #a3#", "", "18.04%"};
		{ 7, 18806, "", "=q4=Core Forged Greaves", "=ds=#s12#, #a4#", "", "16.53%"};
		{ 8, 57069, "", "=q4=Cauterizing Band", "=ds=#s13#", "", "15.10%"};
		{ 9, 57070, "", "=q4=Core Hound Tooth", "=ds=#h1#, #w4#", "", "16.06%"};
		{ 10, 57071, "", "=q4=Finkle's Lava Dredger", "=ds=#h2#, #w6#", "", "12.43%"};
		{ 16, 18703, "", "=q4=Ancient Petrified Leaf", "=ds=#m2# =q1=(#c2#)", "", "35.25%"};
		{ 17, 18715, "", "=q4=Lok'delar, Stave of the Ancient Keepers", "=q1=#m4#: =ds=#w9#, =q1=#m1# =ds=#c2#"};
		{ 18, 18713, "", "=q4=Rhok'delar, Longbow of the Ancient Keepers", "=q1=#m4#: =ds=#w2#, =q1=#m1# =ds=#c2#"};
		{ 19, 18714, "", "=q4=Ancient Sinew Wrapped Lamina", "=q1=#m4#: =ds=#w19#, =q1=#m1# =ds=#c2#"};
		...
		{ 22, 18608, "", "=q4=Benediction", "=q1=#m4#: =ds=#w9#, =q1=#m1# =ds=#c5#"};
		{ 23, 18609, "", "=q4=Anathema", "=q1=#m4#: =ds=#w9#, =q1=#m1# =ds=#c5#"};
		{ 25, 12325, "", "=q4=Reins of the Frenzied Chimera", "=ds=#e12#", "", ""};
		{ 26, 17782, "", "=q5=Talisman of the Binding Shard", "=ds=#s2#", "", "??.??%"};
	...
	AtlasLoot_Data["MCRagnarosHEROIC"] = {
		...
		{ 21, 19138, "", "=q4=Band of Sulfuras", "=ds=#s13#", "", "15.64%"};
		{ 22, 17063, "", "=q4=Band of Accuria", "=ds=#s13#", "", "14.81%"};
		{ 23, 57051, "", "=q4=Shard of the Flame", "=ds=#s14#", "", " 4.65%"};
		{ 24, 57050, "", "=q4=Pure Flame Essence", "=ds=#s14#", "", "17.80%"};
		{ 25, 57073, "", "=q4=Perdition's Blade", "=ds=#h1#, #w4#", "", "15.90%"};
		{ 26, 57074, "", "=q4=Bonereaver's Edge", "=ds=#h2#, #w10#", "", "5.12%"};
		{ 27, 17104, "", "=q4=Spinal Reaper", "=ds=#h2#, #w1#", "", " 4.63%"};
		{ 28, 17106, "", "=q4=Malistar's Defender", "=ds=#w8#", "", "13.88%"};
		{ 30, 21110, "", "=q1=Draconic for Dummies", "=ds=#m3#", "", "100%"};
...
--[[	AtlasLoot_Data["ZFAntusulMYTHIC"] = {
	...
	AtlasLoot_Data["T0Warrior"] = {
		...
		-----------------------------
		--- Mythic Season 1 Items ---
		-----------------------------
		
		AtlasLoot_Data["SEASON1"] = {
	...
	AtlasLoot_Data["SEASON1PAGE2"] = {
		{ 1, 56873, "", "=q4=Dragon's Demise", "=ds=#s13#", "", ""};
		{ 2, 56871, "", "=q4=Dragonflight Band", "=ds=#s13#","",""};	
		{ 3, 56874, "", "=q4=Last Resolve", "=ds=#s13#","",""};
		{ 4, 56872, "", "=q4=Wildcat Signet", "=ds=#s13#","",""};
		{ 5, 57032, "", "=q4=Stone Insignia", "=ds=#s14#", "", ""};	
		{ 6, 56875, "", "=q4=Whale Insignia", "=ds=#s14#","",""};
		Prev = "SEASON1";
		Back = "MYTHICMENU";
	};
...
--		{ 23, 57032, "", "=q4=Stone Insignia", "=ds=#s14#", "25 #eoftriumph#", ""};	
		{ 23, 56989, "", "=q4=Whale Insignia (S2)", "=ds=#s14#", "25 #eoftriumph#", ""};		
	...
	AtlasLoot_Data["SEASON2PAGE2"] = {
		{ 1, 56882, "", "=q4=Chained Totem", "=ds=#w15#", "15 #eoftriumph#", ""};
		{ 2, 56881, "", "=q4=Storm Sigil", "=ds=#w15#", "15 #eoftriumph#", ""};
		{ 3, 56883, "", "=q4=Void Totem", "=ds=#w15#","15 #eoftriumph#",""};
		{ 4, 56876, "", "=q4=Moon's Fury", "=ds=#w14#", "15 #eoftriumph#", ""};
		{ 5, 56877, "", "=q4=The Crying Moon", "=ds=#w14#","15 #eoftriumph#",""};
		{ 6, 56878, "", "=q4=Idol of Massive Growth", "=ds=#w14#", "15 #eoftriumph#", ""};
		{ 7, 40714, "", "=q4=Sigil of the Unfaltering Knight", "=ds=#w21#", "15 #eoftriumph#", ""};
		{ 8, 45254, "", "=q4=Sigil of the Vengeful Heart", "=ds=#w21#","15 #eoftriumph#",""};
		{ 9, 56879, "", "=q4=Valiance Libram", "=ds=#w16#","15 #eoftriumph#",""};
		{ 10, 56880, "", "=q4=Defiance Libram", "=ds=#w16#","15 #eoftriumph#",""};
		Back = "SEASON2";
	};
	
		AtlasLoot_Data["SEASON3"] = {
	...
	AtlasLoot_Data["T1T2Druid"] = {
		...
		{ 2, 54875, "", "=q4=Cenarion Helm (Restoration)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.51%"};
		{ 3, 54876, "", "=q4=Cenarion Spaulders (Restoration)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "19.52%"};
		{ 4, 54877, "", "=q4=Cenarion Vestments (Restoration)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.21%"};
		{ 5, 54878, "", "=q4=Cenarion Bracers (Restoration)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.17%"};
		{ 6, 54879, "", "=q4=Cenarion Gloves (Restoration)", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "19.53%"};
		{ 7, 54880, "", "=q4=Cenarion Belt (Restoration)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.16%"};
		{ 8, 54881, "", "=q4=Cenarion Leggings (Restoration)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "12.90%"};
		{ 9, 54882, "", "=q4=Cenarion Boots (Restoration)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "10.72%"};
	...
	AtlasLoot_Data["T1T2DruidBalance"] = {
		{ 1, 0, "Spell_Nature_Regeneration", "=q6=#t1s1#", "=ec1=#m30#"};
		{ 2, 54867, "", "=q4=Cenarion Helm (Balance)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.51%"};
		{ 3, 54868, "", "=q4=Cenarion Spaulders (Balance)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "19.52%"};
		{ 4, 54869, "", "=q4=Cenarion Vestments (Balance)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.21%"};
		{ 5, 54870, "", "=q4=Cenarion Bracers (Balance)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.17%"};
		{ 6, 54871, "", "=q4=Cenarion Gloves (Balance)", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "19.53%"};
		{ 7, 54872, "", "=q4=Cenarion Belt (Balance)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.16%"};
		{ 8, 54873, "", "=q4=Cenarion Leggings (Balance)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "12.90%"};
		{ 9, 54874, "", "=q4=Cenarion Boots (Balance)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "10.72%"};
		{ 16, 0, "Spell_Nature_Regeneration", "=q6=#t2s1#", "=ec1=#m31#"};
		...
		{ 23, 56893, "", "=q4=Stormrage Legguards (Balance)", "", "", ""};
	...
	AtlasLoot_Data["T1T2DruidFeral"] = {
		{ 1, 0, "Spell_Nature_Regeneration", "=q6=#t1s1#", "=ec1=#m30#"};
		{ 2, 54858, "", "=q4=Cenarion Helm (Feral)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.51%"};
		{ 3, 54859, "", "=q4=Cenarion Spaulders (Feral)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "19.52%"};
		{ 4, 54861, "", "=q4=Cenarion Vestments (Feral)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.21%"};
		{ 5, 54862, "", "=q4=Cenarion Bracers (Feral)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.17%"};
		{ 6, 54863, "", "=q4=Cenarion Gloves (Feral)", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "19.53%"};
		{ 7, 54864, "", "=q4=Cenarion Belt (Feral)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.16%"};
		{ 8, 54865, "", "=q4=Cenarion Leggings (Feral)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "12.90%"};
		{ 9, 54866, "", "=q4=Cenarion Boots (Feral)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "10.72%"};
		{ 16, 0, "Spell_Nature_Regeneration", "=q6=#t2s1#", "=ec1=#m31#"};
		...
		{ 23, 56890, "", "=q4=Stormrage Legguards (Feral)", "", "", ""};
	...
	AtlasLoot_Data["T1T2Hunter"] = {
		...
		{ 2, 16846, "", "=q4=Giantstalker's Helmet", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.57%"};
		{ 3, 16848, "", "=q4=Giantstalker's Epaulets", "=ds="..BabbleBoss["Sulfuron Harbinger"]..", 25 #champseal#", "", "19.64%"};
		{ 4, 16845, "", "=q4=Giantstalker's Breastplate", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.83%"};
		{ 5, 16850, "", "=q4=Giantstalker's Bracers", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.18%"};
		{ 6, 16852, "", "=q4=Giantstalker's Gloves", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "18.58%"};
		{ 7, 16851, "", "=q4=Giantstalker's Belt", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.17%"};
		{ 8, 16847, "", "=q4=Giantstalker's Leggings", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "13.28%"};
		{ 9, 16849, "", "=q4=Giantstalker's Boots", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "14.54%"};
	...
	AtlasLoot_Data["T1T2Mage"] = {
		...
		{ 2, 16795, "", "=q4=Arcanist Crown", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.31%"};
		{ 3, 16797, "", "=q4=Arcanist Mantle", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "19.92%"};
		{ 4, 16798, "", "=q4=Arcanist Robes", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "16.51%"};
		{ 5, 16799, "", "=q4=Arcanist Bindings", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.16%"};
		{ 6, 16801, "", "=q4=Arcanist Gloves", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "19.59%"};
		{ 7, 16802, "", "=q4=Arcanist Belt", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.16%"};
		{ 8, 16796, "", "=q4=Arcanist Leggings", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "14.57%"};
		{ 9, 16800, "", "=q4=Arcanist Boots", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "12.06%"};
	...
	AtlasLoot_Data["T1T2Paladin"] = {
		...
		{ 2, 54915, "", "=q4=Lawbringer Helm (Holy)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "7.23%"};
		{ 3, 54916, "", "=q4=Lawbringer Spaulders (Holy)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "12.62%"};
		{ 4, 54917, "", "=q4=Lawbringer Chestguard (Holy)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "9.53%"};
		{ 5, 54918, "", "=q4=Lawbringer Bracers (Holy)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.11%"};
		{ 6, 54919, "", "=q4=Lawbringer Gauntlets (Holy)", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "11.77%"};
		{ 7, 54920, "", "=q4=Lawbringer Belt (Holy)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.10%"};
		{ 8, 54921, "", "=q4=Lawbringer Legplates (Holy)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "8.54%"};
		{ 9, 54922, "", "=q4=Lawbringer Boots (Holy)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "7.20%"};
	...
	AtlasLoot_Data["T1T2PaladinProt"] = {
		{ 1, 0, "Spell_Holy_SealOfMight", "=q6=#t1s4#", "=ec1=#m30#"};
		{ 2, 54907, "", "=q4=Lawbringer Helm (Protection)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "7.23%"};
		{ 3, 54908, "", "=q4=Lawbringer Spaulders (Protection)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "12.62%"};
		{ 4, 54909, "", "=q4=Lawbringer Chestguard (Protection)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "9.53%"};
		{ 5, 54910, "", "=q4=Lawbringer Bracers (Protection)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.11%"};
		{ 6, 54911, "", "=q4=Lawbringer Gauntlets (Protection)", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "11.77%"};
		{ 7, 54912, "", "=q4=Lawbringer Belt (Protection)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.10%"};
		{ 8, 54913, "", "=q4=Lawbringer Legplates (Protection)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "8.54%"};
		{ 9, 54914, "", "=q4=Lawbringer Boots (Protection)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "7.20%"};
		{ 16, 0, "Spell_Holy_SealOfMight", "=q6=#t2s4#", "=ec1=#m31#"};
		...
		{ 23, 56930, "", "=q4=Judgement Legplates (Protection)", "=ds=", "", ""};
	...
	AtlasLoot_Data["T1T2PaladinRet"] = {
		{ 1, 0, "Spell_Holy_SealOfMight", "=q6=#t1s4#", "=ec1=#m30#"};
		{ 2, 54923, "", "=q4=Lawbringer Helm (Retribution)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "7.23%"};
		{ 3, 54924, "", "=q4=Lawbringer Spaulders (Retribution)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "12.62%"};
		{ 4, 54925, "", "=q4=Lawbringer Chestguard (Retribution)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "9.53%"};
		{ 5, 54926, "", "=q4=Lawbringer Bracers (Retribution)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.11%"};
		{ 6, 54927, "", "=q4=Lawbringer Gauntlets (Retribution)", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "11.77%"};
		{ 7, 54928, "", "=q4=Lawbringer Belt (Retribution)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.10%"};
		{ 8, 54929, "", "=q4=Lawbringer Legplates (Retribution)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "8.54%"};
		{ 9, 54930, "", "=q4=Lawbringer Boots (Retribution)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "7.20%"};
		{ 16, 0, "Spell_Holy_SealOfMight", "=q6=#t2s4#", "=ec1=#m31#"};
		...
		{ 23, 56922, "", "=q4=Judgement Legplates (Retribution)", "=ds=", "", ""};
	...
	AtlasLoot_Data["T1T2Priest"] = {
		...
		{ 2, 16813, "", "=q4=Circlet of Prophecy", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.36%"};
		{ 3, 16816, "", "=q4=Mantle of Prophecy", "=ds="..BabbleBoss["Sulfuron Harbinger"]..", 25 #champseal#", "", "21.06%"};
		{ 4, 16815, "", "=q4=Robes of Prophecy", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.65%"};
		{ 5, 16819, "", "=q4=Vambraces of Prophecy", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.16%"};
		{ 6, 16812, "", "=q4=Gloves of Prophecy", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "18.65%"};
		{ 7, 16817, "", "=q4=Girdle of Prophecy", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.18%"};
		{ 8, 16814, "", "=q4=Pants of Prophecy", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "14.33%"};
		{ 9, 16811, "", "=q4=Boots of Prophecy", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "14.90%"};
	...
	AtlasLoot_Data["T1T2PriestShadow"] = {
		{ 1, 0, "Spell_Holy_PowerWordShield", "=q6=#t1s5#", "=ec1=#m30#"};
		{ 2, 54931, "", "=q4=Circlet of Prophecy (Shadow)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.36%"};
		{ 3, 54932, "", "=q4=Mantle of Prophecy (Shadow)", "=ds="..BabbleBoss["Sulfuron Harbinger"]..", 25 #champseal#", "", "21.06%"};
		{ 4, 54933, "", "=q4=Robes of Prophecy (Shadow)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.65%"};
		{ 5, 54934, "", "=q4=Vambraces of Prophecy (Shadow)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.16%"};
		{ 6, 54935, "", "=q4=Gloves of Prophecy (Shadow)", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "18.65%"};
		{ 7, 54936, "", "=q4=Girdle of Prophecy (Shadow)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.18%"};
		{ 8, 54937, "", "=q4=Pants of Prophecy (Shadow)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "14.33%"};
		{ 9, 54938, "", "=q4=Boots of Prophecy (Shadow)", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "14.90%"};
		{ 16, 0, "Spell_Holy_PowerWordShield", "=q6=#t2s5#", "=ec1=#m31#"};
		...
		{ 23, 56914, "", "=q4=Leggings of Transcendence (DPS)", "=ds=", "", ""};
	...
	AtlasLoot_Data["T1T2Rogue"] = {
		...
		{ 2, 16821, "", "=q4=Nightslayer Cover", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "10.38%"};
		{ 3, 16823, "", "=q4=Nightslayer Shoulder Pads", "=ds="..BabbleBoss["Sulfuron Harbinger"]..", 25 #champseal#", "", "20.66%"};
		{ 4, 16820, "", "=q4=Nightslayer Chestpiece", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "16.76%"};
		{ 5, 16825, "", "=q4=Nightslayer Bracelets", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.17%"};
		{ 6, 16826, "", "=q4=Nightslayer Gloves", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "19.47%"};
		{ 7, 16827, "", "=q4=Nightslayer Belt", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.15%"};
		{ 8, 16822, "", "=q4=Nightslayer Pants", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "13.83%"};
		{ 9, 16824, "", "=q4=Nightslayer Boots", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "15.58%"};
	...
	AtlasLoot_Data["T1T2Shaman"] = {
		...
		{ 2, 16842, "", "=q4=Earthfury Helmet", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "3.91%"};
		{ 3, 16844, "", "=q4=Earthfury Epaulets", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "7.29%"};
		{ 4, 16841, "", "=q4=Earthfury Vestments", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "6.08%"};
		{ 5, 16840, "", "=q4=Earthfury Bracers", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.06%"};
		{ 6, 16839, "", "=q4=Earthfury Gauntlets", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "7.38%"};
		{ 7, 16838, "", "=q4=Earthfury Belt", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.07%"};
		{ 8, 16843, "", "=q4=Earthfury Legguards", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "4.73%"};
		{ 9, 16837, "", "=q4=Earthfury Boots", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "4.16%"};
	...
	AtlasLoot_Data["T1T2ShamanEle"] = {
		{ 1, 0, "Spell_FireResistanceTotem_01", "=q6=#t1s7#", "=ec1=#m30#"};
		{ 2, 54891, "", "=q4=Earthfury Helmet (Elemental)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "3.91%"};
		{ 3, 54892, "", "=q4=Earthfury Epaulets (Elemental)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "7.29%"};
		{ 4, 54893, "", "=q4=Earthfury Vestments (Elemental)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "6.08%"};
		{ 5, 54894, "", "=q4=Earthfury Bracers (Elemental)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.06%"};
		{ 6, 54895, "", "=q4=Earthfury Gauntlets (Elemental)", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "7.38%"};
		{ 7, 54896, "", "=q4=Earthfury Belt (Elemental)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.07%"};
		{ 8, 54897, "", "=q4=Earthfury Legguards (Elemental)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "4.73%"};
		{ 9, 54898, "", "=q4=Earthfury Boots (Elemental)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "4.16%"};
		{ 16, 0, "Spell_FireResistanceTotem_01", "=q6=#t2s7#", "=ec1=#m31#"};
		...
		{ 23, 56941, "", "=q4=Legplates of Ten Storms (Elemental)", "=ds=", "", ""};
	...
	AtlasLoot_Data["T1T2ShamanEnh"] = {
		{ 1, 0, "Spell_FireResistanceTotem_01", "=q6=#t1s7#", "=ec1=#m30#"};
		{ 2, 54899, "", "=q4=Earthfury Helmet (Enhancement)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "3.91%"};
		{ 3, 54900, "", "=q4=Earthfury Epaulets (Enhancement)", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "7.29%"};
		{ 4, 54901, "", "=q4=Earthfury Vestments (Enhancement)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "6.08%"};
		{ 5, 54902, "", "=q4=Earthfury Bracers (Enhancement)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.06%"};
		{ 6, 54903, "", "=q4=Earthfury Gauntlets (Enhancement)", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "7.38%"};
		{ 7, 54904, "", "=q4=Earthfury Belt (Enhancement)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.07%"};
		{ 8, 54905, "", "=q4=Earthfury Legguards (Enhancement)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "4.73%"};
		{ 9, 54906, "", "=q4=Earthfury Boots (Enhancement)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "4.16%"};
		{ 16, 0, "Spell_FireResistanceTotem_01", "=q6=#t2s7#", "=ec1=#m31#"};
		...
		{ 23, 56938, "", "=q4=Legplates of Ten Storms (Enhancement)", "=ds=", "", ""};
	...
	AtlasLoot_Data["T1T2Warlock"] = {
		...
		{ 2, 16808, "", "=q4=Felheart Horns", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "10.62%"};
		{ 3, 16807, "", "=q4=Felheart Shoulder Pads", "=ds="..BabbleBoss["Baron Geddon"]..", 25 #champseal#", "", "19.78%"};
		{ 4, 16809, "", "=q4=Felheart Robes", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.66%"};
		{ 5, 16804, "", "=q4=Felheart Bracers", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.16%"};
		{ 6, 16805, "", "=q4=Felheart Gloves", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "14.89%"};
		{ 7, 16806, "", "=q4=Felheart Belt", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.19%"};
		{ 8, 16810, "", "=q4=Felheart Pants", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "13.75%"};
		{ 9, 16803, "", "=q4=Felheart Slippers", "=ds="..BabbleBoss["Shazzrah"]..", 15 #champseal#", "", "15.28%"};
	...
	AtlasLoot_Data["T1T2WarriorDPS"] = {
		{ 1, 0, "INV_Shield_05", "=q6=#t1s9#", "=ec1=#m30#"};
		{ 2, 54883, "", "=q4=Helm of Might (DPS)", "=ds="..BabbleBoss["Garr"]..", 25 #champseal#", "", "11.39%"};
		{ 3, 54884, "", "=q4=Pauldrons of Might (DPS)", "=ds="..BabbleBoss["Sulfuron Harbinger"]..", 25 #champseal#", "", "21.14%"};
		{ 4, 54885, "", "=q4=Breastplate of Might (DPS)", "=ds="..BabbleBoss["Golemagg the Incinerator"]..", 25 #champseal#", "", "15.28%"};
		{ 5, 54886, "", "=q4=Bracers of Might (DPS)", "=ds="..AL["Trash Mobs"]..", 10 #champseal#", "", "0.16%"};
		{ 6, 54887, "", "=q4=Gauntlets of Might (DPS)", "=ds="..BabbleBoss["Lucifron"]..", 15 #champseal#", "", "16.40%"};
		{ 7, 54888, "", "=q4=Belt of Might (DPS)", "=ds="..AL["Trash Mobs"]..", 15 #champseal#", "", "0.16%"};
		{ 8, 54889, "", "=q4=Legplates of Might (DPS)", "=ds="..BabbleBoss["Magmadar"]..", 25 #champseal#", "", "13.97%"};
		{ 9, 54890, "", "=q4=Sabatons of Might (DPS)", "=ds="..BabbleBoss["Gehennas"]..", 15 #champseal#", "", "14.48%"};
		{ 16, 0, "INV_Shield_05", "=q6=#t2s9#", "=ec1=#m31#"};
		...
		{ 23, 56906, "", "=q4=Legplates of Wrath (DPS)", "=ds=", "", ""};
